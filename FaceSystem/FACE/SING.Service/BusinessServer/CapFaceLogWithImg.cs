...
[Serializable]
#endif
public partial class CapFaceLogWithImg : TBase
{
  private string _ID;
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("CapFaceLogWithImg");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("CapFaceLogWithImg(");
    bool __first = true;
    if (ID != null && __isset.ID) {
