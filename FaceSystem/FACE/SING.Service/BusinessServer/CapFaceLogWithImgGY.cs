...
[Serializable]
#endif
public partial class CapFaceLogWithImgGY : TBase
{
  private string _ID;
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("CapFaceLogWithImgGY");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("CapFaceLogWithImgGY(");
    bool __first = true;
    if (ID != null && __isset.ID) {
