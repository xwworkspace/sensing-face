...
using FACE_CaptureComparisonManagement.Services;
...
namespace FACE_CaptureComparisonManagement.ViewModels
{
    [Export]
    ...
    public class ViewModel : NotificationObject, INavigationAware
    {
        ...
        public ListView RealTimeCmpListView;
        ...
        private List<ZoneCfgViewData> _zoneChannelList;

        public List<ZoneCfgViewData> ZoneChannelList
        {
            get
            {
                return _zoneChannelList;
            }
            set
            {
                this._zoneChannelList = value;
                RaisePropertyChanged("ZoneChannelList");
            }
        }

        private ICollectionView _zoneChannelCV;
        public ICollectionView ZoneChannelCV
        {
            get
            {
                return _zoneChannelCV;
            }
            set
            {
                _zoneChannelCV = value;
                RaisePropertyChanged("ZoneChannelCV");
            }
        }
        ...
        private int comImageCount { get; set; }
        public int ComImageCount
        {
            ...
            {
                comImageCount = value;
                RaisePropertyChanged("ComImageCount");
            }
        }
        ...
        private void InitialZoneChannel()
        {
            _dataService.FindAllZoneChannel(this);
        }
